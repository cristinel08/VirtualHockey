	...
	hInst( hInst )
{
	...
	wc.hIconSm = (HICON)LoadImage( hInst,MAKEINTRESOURCE( IDI_ICON2 ),IMAGE_ICON,16,16,0 );
	wc.hIcon = (HICON)LoadImage( hInst,MAKEINTRESOURCE( IDI_ICON2 ),IMAGE_ICON,32,32,0 );
	...
	hWnd = CreateWindow( wndClassName,L"Virtual Hockey",
